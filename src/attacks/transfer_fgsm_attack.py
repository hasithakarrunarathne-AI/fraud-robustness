...
def generate_mlp_fgsm_adversarial_examples(model, X_test_np, y_test, epsilon):
...
def run_transfer_fgsm():
    ...
    for epsilon in epsilons:
        ...
        # -------------------------------------------------
        # Evaluate on source MLP too, for comparison
        # -------------------------------------------------
    ...
    json_path = "results/attacks/transfer_fgsm_results.json"
    csv_path = "results/attacks/transfer_fgsm_results.csv"
    ...
    print(f"\nSaved transfer FGSM results to {json_path}")
    print(f"Saved transfer FGSM results to {csv_path}")
